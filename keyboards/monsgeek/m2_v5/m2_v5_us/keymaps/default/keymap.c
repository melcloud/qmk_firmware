...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT( /* Base */
        ...
        KC_LCTL,  KC_LCMD,  KC_LALT,                                KC_SPC,                                 KC_RALT,  MO(_FL),  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,    KC_PDOT           
        ),

    [_FL] = LAYOUT( /* Base */
        _______,  KC_MYCM,  KC_MAIL,  KC_WSCH,  KC_WHOM,  KC_MSEL,  KC_MPLY,  KC_MPRV,  KC_MNXT,  _______,  _______,  _______,  _______,  RGB_MOD,  _______,  _______,  _______,  _______,
        EE_CLR,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  RGB_SPD,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,   
        _______,  _______,  HS_DIR,   KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   KC_USB,   _______,  RL_MOD,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  
        _______,  _______,  _______,  _______,  _______,  LED_TOG,  _______,  _______,  _______,  RGB_TOG,  _______,            _______,  _______,  _______,  _______,  _______,  
        _______,            _______,  _______,  KC_CALC,  _______,  NK_TOGG,  _______,  KC_MUTE,  KC_VOLD,  KC_VOLU,  RGB_TOG,  MO(_FBL), RGB_VAI,  _______,  _______,  _______,  _______,
        _______,  GU_TOGG,  _______,                                HS_BATQ,                                _______,  _______,  RGB_HUD,  RGB_VAD,  RGB_HUI,  _______,  _______ 
        ),

    [_MBL] = LAYOUT( /* Base */ 
        KC_ESC,   KC_BRID,  KC_BRIU,  KC_MCTL,  HS_SIRI,  KC_F5,    KC_F6,    KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_DEL,   KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN, 
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,  KC_NUM,   KC_PSLS,  KC_PAST,  KC_PMNS,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_P7,    KC_P8,    KC_P9,    KC_PPLS,    
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,            KC_QUOT,  KC_ENT,   KC_P4,    KC_P5,    KC_P6,          
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,    KC_P1,    KC_P2,    KC_P3,    KC_PENT,
        KC_LCTL,  KC_LALT,  KC_LCMD,                                KC_SPC,                                 KC_RCMD,  MO(_MFL), KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,    KC_PDOT 
        ),

    [_MFL] = LAYOUT( /* Base */
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   RGB_MOD,  _______,  _______,  _______,  _______,
        EE_CLR,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  RGB_SPD,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,   
        _______,  _______,  HS_DIR,   KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   KC_USB,   _______,  RL_MOD,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  
        _______,  _______,  _______,  _______,  _______,  LED_TOG,  _______,  _______,  _______,  RGB_TOG,  _______,            _______,  _______,  _______,  _______,  _______,  
        _______,            _______,  _______,  KC_CALC,  _______,  NK_TOGG,  _______,  KC_MUTE,  KC_VOLD,  KC_VOLU,  RGB_TOG,  MO(_FBL), RGB_VAI,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,                                HS_BATQ,                                _______,  _______,  RGB_HUD,  RGB_VAD,  RGB_HUI,  _______,  _______ 
        ),
    [_FBL] = LAYOUT( /* Base */
        ...
        _______,  _______,  _______,  _______,  BT_TEST,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______, 
...
const uint16_t PROGMEM rgbrec_default_effects[RGBREC_CHANNEL_NUM][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
       ...
       HS_RED,             ________, ________, ________, HS_RED,   ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, ________,
    ...
    [2] = LAYOUT(
       ...
       ________,           ________, HS_BLUE,  HS_BLUE,  ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, ________,
